class SalesCheckCommentsController < ApplicationController
  ...
  def create
    ...
    if params[:back]
      ...
      if @sales_check_comment.save
        ...
        redirect_to @sales_check_comment, notice: t('sales_check_comments.create')
      else
  ...
  def update
      if @sales_check_comment.update(sales_check_comment_params)
        redirect_to @sales_check_comment, notice: t('sales_check_comments.edit')
      else
        render :edit
      end
  end
  ...
  def destroy
    ...
    redirect_to sales_check_comments_url, notice: t('sales_check_comments.delete')
  end
